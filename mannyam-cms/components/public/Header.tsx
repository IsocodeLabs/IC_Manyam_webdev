        ...
        <nav className="hidden lg:flex items-center gap-1" data-mega>
          ...
          >
            ...
            {openMega === "experiences" && (
              <div className="fixed top-[76px] left-1/2 -translate-x-1/2 w-[min(840px,calc(100vw-3rem))] bg-paper border border-gold/25 rounded-[18px] shadow-[0_18px_48px_-24px_rgba(30,35,25,.26)] p-[22px] z-50 animate-fade-in overflow-hidden">
